...
const rawEntries: RawEntries = {
  ...
  "ja": [
    {
      "date": "10/19/2017",
      "text": "国際会議<a href=\"https://2017.splashcon.org/\" title=\"The ACM SIGPLAN conference on Systems, Programming, Languages and Applications: Software for Humanity\">SPLASH</a> <a href=\"https://2017.splashcon.org/track/live-2017#program\">LIVE 2017</a>で<a href=\"https://junkato.jp/ja/blog/2017/10/08/live-programming/\">Live Programming</a>に関して基調講演します。<a href=\"https://sigpx.org/\">SIGPX</a>で扱ってきたさまざまなトピックをカバーした情報処理学会 学会誌の小特集「<a href=\"https://sigpx.org/ipsj2017\">プログラミング・エクスペリエンスの新潮流</a>」でエディタを務めました。"
    },
    {
      "date": "09/20/2017",
    ...
    {
      "date": "03/13/2016",
      "text": "情報処理学会 <a href=\"http://ipsj-one.org/\">IPSJ-ONE</a>で<abbr title=\"Human-Computer Interaction\">HCI</abbr>研究会の推薦を受けて「<a href=\"http://junkato.jp/ja/blog/2016/03/16/ipsj-one-px-science-as-a-service/\">コンピュータを変幻自在の道具にするためのプログラミング環境技術</a>」と題して講演しました。また、<a href=\"http://sigpx.org\">SIGPX</a>初回は盛会でした！ご参加ありがとうございました。"
    },
    {
      "date": "03/04/2016",
    ...
    {
      "date": "07/01/2015",
      "text": "<a href=\"http://junkato.jp/ja/blog/2015/06/29/cs-research-internship-abroad/\">情報科学系 海外研究インターンのすすめ〔前</a>・<a href=\"http://junkato.jp/ja/blog/2015/06/30/cs-research-internship-abroad-2/\">後編〕</a>を書きました。学生の方はご参考にどうぞ。"
    },
    {
      "date": "06/19/2015",
      "text": "情報処理学会会誌「情報処理」今月号に<a href=\"http://id.nii.ac.jp/1001/00142321/\">ACM CHI 2015 参加報告</a>が掲載されました。<a href=\"http://junkato.jp/ja/blog/2015/05/03/acm-chi2015-japan/\">ブログ記事</a>と合わせて<a href=\"http://hci.tokyo/seminar/chi2015\">ACM CHI勉強会 2015</a>の予習教材にどうぞ。"
    },
    {
      "date": "05/14/2015",
    ...
    {
      "date": "05/03/2015",
      "text": "国際会議<a href=\"http://chi2015.acm.org/\">ACM CHI 2015</a>「Programming Environments」セッションで<a href=\"https://staff.aist.go.jp/jun.kato/TextAlive/\">TextAlive</a>の登壇発表を行い、<a href=\"http://hci.tokyo/\">Japanese HCI Symposium</a>を主催しました。シンポジウムの様子を<a href=\"/ja/blog/2015/05/03/acm-chi2015-japan/\">ブログ記事</a>に掲載しました。"
    },
    {
      "date": "03/20/2015",
...
for (const lang in rawEntries) {
  ...
  for (const re of res) {
    (<any>entries)[lang].push(new Entry(new Date(re.date), re.text));
  }
}
